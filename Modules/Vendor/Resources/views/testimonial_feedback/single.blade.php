    ...
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="record">
                    ...
                    <div class="card-body call-center-bg-gray">
                        <div class="row">
                            @if ($record->video)
                                ...
                                <div class="col-md-3">
                                    <a href="{{asset('storage/'.$record->video)}}" download><i class="c-deep-purple-500 ti-download"></i></a>
                                </div>
                            @endif
                            @if ($record->audio)
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <a href="{{asset('storage/'.$record->audio)}}" download><i class="c-deep-purple-500 ti-download"></i></a>
                                </div>
                            @endif
                            @if ($record->image)
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <a href="{{asset('storage/'.$record->image)}}" download><i class="c-deep-purple-500 ti-download"></i></a>
                                </div>
                            @endif
                            @if ($record->text)
                                <div class="col-md-6">
                                ...
                                <div class="col-md-3">
                                    <a href="{{asset('storage/'.$record->text)}}" download><i class="c-deep-purple-500 ti-download"></i></a>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                @if($geo_data['geo_address'])
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        <span class="details-label">Location :</span> <a target="_blank" href="http://maps.google.com/maps?z=18&q={{$geo_data['latitude']}},{{$geo_data['longitude']}}"> {{ $geo_data['geo_address'] }} </a>
                    </div>
                </div>
                @endif
