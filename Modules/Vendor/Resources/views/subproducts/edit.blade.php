{{ Form::open(array('url' => route('vendor.subproducts.update', $subproduct['id']), 'class'=>'text-form', 'method' => 'put', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Edit Subproduct</h4>
...
<div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <select name="product_id" id="product_id" class="form-control" data-live-search="true">
                    ...
                    <option value="{{ $product->id }}" @if($subproduct['product_id'] == $product->id) selected @endif>{{ $product->product_code }} - {{ $product->product_name }}</option>
                    @endforeach
                </select>
    ...
    <div class='col-lg-8 offset-lg-2'>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="subproduct_code" name="subproduct_code" value="{{$subproduct['subproduct_code']}}">
    ...
    <div class='col-lg-8 offset-lg-2'>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="subproduct_name" name="subproduct_name" value="{{$subproduct['subproduct_name']}}">
    ...
    <div class='col-lg-8 offset-lg-2'>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" id="description" name="description"  value="{{$subproduct['description']}}">
