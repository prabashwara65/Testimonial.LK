{{ Form::open(array('url' => route('vendor.vendors.update', $vendor['id']), 'class'=>'text-form', 'files' => 'true', 'method' => 'put', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Edit Vendor</h4>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="company_name" name="company_name"  value="{{!empty($vendor['company_name'])? $vendor['company_name']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="br_no" name="br_no" value="{{!empty($vendor['br_no'])? $vendor['br_no']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="email" class="form-control" id="email" name="email" value="{{!empty($vendor['email'])? $vendor['email']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="contact_no" name="contact_no" value="{{!empty($vendor['contact_no'])? $vendor['contact_no']: ''}}">
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address" name="address" value="{{!empty($vendor['address'])? $vendor['address']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line1" name="address_line1" value="{{!empty($vendor['address_line1'])? $vendor['address_line1']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line2" name="address_line2" value="{{!empty($vendor['address_line2'])? $vendor['address_line2']: ''}}">
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->id }}"
                                        @if($vendor['region_id'] == $region->id) selected
                                            <?php $countries = \App\Models\Country::where('region_id', $vendor['region_id'])->get(); ?>
                                        @endif>{{ $region->region }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="country_id" id="country_id" class="form-control" data-live-search="true">
                                ...
                                <option value="{{ $country->id }}" @if($vendor['country_id'] == $country->id) selected @endif>{{ $country->country }}</option>
                                @endforeach
                            </select>
        ...
        <div class="form-group col-sm-6 row">
            ...
            <div class="col-sm-7">
                <select name="file_size" id="file_size" class="form-control" data-live-search="true">
                    <option value="5" @if($vendor['file_size'] == 5) selected @endif>5MB</option>
                    <option value="10" @if($vendor['file_size'] == 10) selected @endif>10MB</option>
                    <option value="20" @if($vendor['file_size'] == 20) selected @endif>20MB</option>
                </select>
