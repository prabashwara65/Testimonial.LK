...
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">View User</h4>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="emp_id" name="emp_id" value="{{!empty($user['emp_id'])? $user['emp_id']: ''}}" disabled>
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="username" name="username" value="{{!empty($user['username'])? $user['username']: ''}}" disabled>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="department" name="department" value="{{!empty($user['department'])? $user['department']: ''}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="designation" name="designation" value="{{!empty($user['designation'])? $user['designation']: ''}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select name="branch_id" id="branch_id" class="form-control" data-live-search="true" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <select name="role[]" id="role" class="form-control" multiple data-live-search="true" disabled>
...
<!--        <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="incentive_cal" name="incentive_cal" value="{{!empty($user['incentive_cal'])? $user['incentive_cal']: ''}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="incentive_rate" name="incentive_rate" value="{{!empty($user['incentive_rate'])? $user['incentive_rate']: ''}}" disabled>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="bank_account" name="bank_account" value="{{!empty($user['bank_account'])? $user['bank_account']: ''}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="bank" name="bank" value="{{!empty($user['bank'])? $user['bank']: ''}}" disabled>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="bank_branch" name="bank_branch" value="{{!empty($user['bank_branch'])? $user['bank_branch']: ''}}" disabled>
