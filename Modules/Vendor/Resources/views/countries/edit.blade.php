{{ Form::open(array('url' => route('vendor.countries.update', $country['id']), 'class'=>'text-form', 'method' => 'put', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Edit Product</h4>
...
<div class="modal-body">
    ...
    <div class='col-lg-8 offset-lg-2'>
        <div class="form-group row">
            <label for="country" class="col-sm-2 col-form-label">Country Name<i class="required-star"></i></label>
            <div class="col-sm-10">
