{{ Form::open(array('url' => route('vendor.company.update', $company['id']), 'class'=>'text-form', 'files' => 'true', 'method' => 'put', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Edit Company</h4>
...
<div class="modal-body">
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="br_no" name="br_no" value="{{!empty($company['br_no'])? $company['br_no']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="email" class="form-control" id="email" name="email" value="{{!empty($company['email'])? $company['email']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="contact_no" name="contact_no" value="{{!empty($company['contact_no'])? $company['contact_no']: ''}}">
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address" name="address" value="{{!empty($company['address'])? $company['address']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line1" name="address_line1" value="{{!empty($company['address_line1'])? $company['address_line1']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line2" name="address_line2" value="{{!empty($company['address_line2'])? $company['address_line2']: ''}}">
                            ...
                            <select name="region_id" id="region_id" class="form-control load-data-on-change" data-url="{{$loadCountriesUrl}}" data-target="#country_id" data-live-search="true">
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->id }}"
                                        @if($company['region_id'] == $region->id) selected
                                            <?php $countries = \App\Models\Country::where('region_id', $company['region_id'])->get(); ?>
                                        @endif>{{ $region->region }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="country_id" id="country_id" class="form-control" data-live-search="true">
                                ...
                                <option value="{{ $country->id }}" @if($company['country_id'] == $country->id) selected @endif>{{ $country->country }}</option>
                                @endforeach
                            </select>
    ...
    <div class="row">
        <div class="form-group col-sm-6 row">
            <label for="logo" class="col-sm-5 col-form-label">Logo
