{{ Form::open(array('url' => route('admin.users.update', $user['id']), 'class'=>'text-form', 'method' => 'put', 'onsubmit' => 'return false;')) }}
                ...
                <div class="col-sm-9">
                    <select name="role[]" id="role" class="form-control" multiple data-live-search="true">
                        @foreach ($roles as $role)
                            @if(!auth()->user()->hasRole('Super Admin') && ($role->id == 1 || $role->name == "Super Admin")) @continue @endif
