{{ Form::open(array('url' => route('admin.customers.update', $customer['id']), 'class'=>'text-form', 'method' => 'put', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Edit Customer</h4>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="name" name="name" value="{{!empty($customer['name'])? $customer['name']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="last_name" name="last_name" value="{{!empty($customer['last_name'])? $customer['last_name']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nic" name="nic" value="{{!empty($customer['nic'])? $customer['nic']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="email" class="form-control" id="email" name="email" value="{{!empty($customer['email'])? $customer['email']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="mobile" name="mobile" value="{{!empty($customer['mobile'])? $customer['mobile']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address" name="address" value="{{!empty($customer['address'])? $customer['address']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line1" name="address_line1" value="{{!empty($customer['address_line1'])? $customer['address_line1']: ''}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="address_line2" name="address_line2" value="{{!empty($customer['address_line2'])? $customer['address_line2']: ''}}">
                ...
                <div class="col-sm-9">
                    <select name="region_id" id="region_id" class="form-control load-data-on-change" data-url="{{$loadCountriesUrl}}" data-target="#country_id" data-live-search="true">
                        ...
                        @foreach ($regions as $region)
                            ...
                            <?php $countries = \App\Models\Country::where('region_id', $customer['region_id'])->get(); ?>
                                @endif>{{ $region->region }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-9">
                    <select name="country_id" id="country_id" class="form-control" data-live-search="true">
                        ...
                        @foreach ($countries as $country)
                            <option value="{{ $country->id }}" @if($customer['country_id'] == $country->id) selected @endif>{{ $country->country }}</option>
                        @endforeach
                    </select>
