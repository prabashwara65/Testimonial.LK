{{ Form::open(array('url' => route('admin.vendor-companies.store'), 'class'=>'text-form', 'files' => 'true', 'onsubmit' => 'return false;')) }}
<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">Add New Vendor Company</h4>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group row">
                <label for="company_name" class="col-sm-4 col-form-label">Company Name <i class="required-star"></i></label>
                <div class="col-sm-8">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="renewal_start_date" id="renewal_start_date" class="form-control datepicker" data-date-format="yyyy-mm-dd" value="{{date("Y-m-d")}}">
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                ...
                <div class="col-sm-5 pr-0">
                    <select name="limit_regions[]" id="limit_regions" class="form-control load-data-on-change" data-url="{{route('load-countries')}}" data-target="#limit_countries" data-live-search="true" multiple>
                        @foreach ($regions as $region)
                            <option value="{{ $region->id }}">{{ $region->region }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-sm-3 pl-0">
                    <button class="btn btn-default" onclick="selectAll('#limit_regions')"><i class="icon-checkbox-checked"></i></button>
                    <button class="btn btn-default" onclick="unSelectAll('#limit_regions')"><i class="icon-checkbox-unchecked"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                <label for="limit_countries" class="col-sm-4 col-form-label">Limit Countries <span
                        class="required-star"></span></label>
                <div class="col-sm-5 pr-0">
                    <select name="limit_countries[]" id="limit_countries" class="form-control load-data-on-change" data-url="{{route('load-provinces')}}" data-target="#limit_provinces" data-live-search="true" multiple>
                    </select>
                    <span class="invalid-feedback limit_countries-error" role="alert"></span>
                </div>
                <div class="col-sm-3 pl-0">
                    <button class="btn btn-default" onclick="selectAll('#limit_countries')"><i class="icon-checkbox-checked"></i></button>
                    <button class="btn btn-default" onclick="unSelectAll('#limit_countries')"><i class="icon-checkbox-unchecked"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                <label for="limit_provinces" class="col-sm-4 col-form-label">Limit Provinces <span
                        class="required-star"></span></label>
                <div class="col-sm-5 pr-0">
                    <select name="limit_provinces[]" id="limit_provinces" class="form-control load-data-on-change" data-url="{{route('load-districts')}}" data-target="#limit_districts" data-live-search="true" multiple>
                    </select>
                    <span class="invalid-feedback limit_provinces-error" role="alert"></span>
                </div>
                <div class="col-sm-3 pl-0">
                    <button class="btn btn-default" onclick="selectAll('#limit_provinces')"><i class="icon-checkbox-checked"></i></button>
                    <button class="btn btn-default" onclick="unSelectAll('#limit_provinces')"><i class="icon-checkbox-unchecked"></i></button>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group row">
                <label for="limit_districts" class="col-sm-4 col-form-label">Limit Districts <span
                        class="required-star"></span></label>
                <div class="col-sm-5 pr-0">
                    <select name="limit_districts[]" id="limit_districts" class="form-control" data-live-search="true" multiple>
                    </select>
                    <span class="invalid-feedback limit_districts-error" role="alert"></span>
                </div>
                <div class="col-sm-3 pl-0">
                    <button class="btn btn-default" onclick="selectAll('#limit_districts')"><i class="icon-checkbox-checked"></i></button>
                    <button class="btn btn-default" onclick="unSelectAll('#limit_districts')"><i class="icon-checkbox-unchecked"></i></button>
                </div>
            </div>
        </div>
    </div>
