	...
	if (localStream == null) {
		...
		mediaRecorder.onstop = function(){
			...
			*/
			...
			/*if ('srcObject' in playbackAudioElement) {
			  try {
			    playbackAudioElement.srcObject = recording;
			  } catch (err) {
		...
		pauseResBtn.innerHTML = "<i class=\"fas fa-pause f16 text-color\"></i> Pause";
...
function onPauseResumeClicked(){
	if(pauseResBtn.innerHTML === "<i class=\"fas fa-pause f16 text-color\"></i> Pause"){
		pauseResBtn.innerHTML = "<i class=\"fas fa-play f16 text-color\"></i> Resume";
		mediaRecorder.pause();
		stopBtn.disabled = true;
	}else{
		pauseResBtn.innerHTML = "<i class=\"fas fa-pause f16 text-color\"></i> Pause";
...
function onBtnRecaptureClicked(){
...
function onBtnUploadClicked(){
    let file = new File(chunks, name,{type: mediaRecorder.mimeType, lastModified:new Date().getTime()});
    let fileInputElement = document.getElementById('audio');
