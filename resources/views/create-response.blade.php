                                    ...
                                    <div class="tab-pane wizard-tab-pane active" role="tabpanel" id="step1">
                                        <div class="form-row row">
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                ...
                                                <select id="vendor_company_id" name="vendor_company_id" class="form-control custom-select load-data-on-change" data-url="{{$loadBranchesUrl}}" data-target="#branch_id">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                <label for="branch_id" >Select Branch <sup class="red-color">*</sup></label>
                                                <select id="branch_id" name="branch_id" class="form-control custom-select load-data-on-change" data-url="{{$loadProductsUrl}}" data-target="#product_id">
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-3">
                                                ...
                                                <select id="subproduct_id" name="subproduct_id" class="form-control custom-select">
                                                </select>
                                            </div>
                                        </div>
