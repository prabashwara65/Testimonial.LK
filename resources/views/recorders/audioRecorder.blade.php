<div class="modal-header">
    <h4 class="modal-title c-grey-900 ">AUDIO RECORDER</h4>
    <button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
<div class="modal-body">
    <div id="livePanel">
        <div id="audioDiv" style="height: 50px;"></div>
        <div id="controls">
    ...
    <div id="playbackPanel" style="display: none">
        <audio id="playback" width="100%" controls autoplay></audio>
        <div id="controls">
            ...
            <a id="downloadLink" download="mediarecorder.webm" name="mediarecorder.webm" href>
                <button class="btn view-button btn-lg mb-2"><i class="fas fa-download f16 text-color"></i> Download Audio</button>
            </a>
    ...
    <script src="{{ asset('assets/custom/js/audio_recorder.js') }}"></script>
</div>
...
<script>
    ...
    $("#resume, #countdown, #audioDiv").hide();
