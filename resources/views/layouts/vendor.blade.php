                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand homeLink" href="{{ url('/') }}"><img src="{{ asset('assets/web/images/logo.jpg') }}" alt="logo"></a>
                                </div>
                                <div style="height: 1px;" role="main" aria-expanded="false"
                                    ...
                                    <ul class="nav navbar-nav navbar-nav-centered">
                                        <li class="nav-item {{ Request::is('vendor') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('vendor.salesrep.dashboard') }}">Dashboard</a>
                                        </li>
                                        <li class="nav-item {{ Request::is('vendor/response/*') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('response.step-one') }}">Testimonial & Feedback</a>
                                        </li>
                                        <li class="nav-item {{ Request::is('vendor/collection') ? 'active' : '' }}">
                                            <a class="nav-link" href="{{ route('collection') }}">Testimonial & Feedback Collection</a>
                                        </li>
                                    </ul>
...
{{--                                                <li><a class="dropdown-item" href="#">My Profile</a></li>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-3 col-md-4 col-lg-3">
                        <div class="footer-menu">
                            ...
                            <ul>
                                ...
                                <li><a href="#" data-toggle="modal" data-target="#loginForTestimonialModal">Testimonial & Feedback</a></li>
                                <li><a href="{{ url('/sales-rep-dashboard') }}">Dashboard</a></li>
                                <li><a href="{{ url('/my-testimonials') }}">My Testimonials & Feedback</a></li>
                                <li><a href="{{ url('/testimonial-feedback-collection') }}">Testimonial & Feedback Collection</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <div class="footer-menu custom-footer-menu">
                            <h4>Contact us</h4>
                            <ul>
                                <li><a href="tel:+94779968924"> <span class="mr-5"><i class="fas fa-phone"></i></span> +94 77 996 8924</a></li>
                                <li><a href="mailto:info@testimonial.lk" target="_blank"> <span class="mr-5"><i class="fas fa-envelope"></i></span> info@testimonial.lk</a></li>
                                <li><a href="#" target="_blank"> <span class="mr-5"><i class="fas fa-map-marker-alt"></i></span> 42/4A, Jubillee Mawatha, Colombo 15</a></li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="loginForTestimonialModal" tabindex="-1" role="dialog" aria-labelledby="loginForTestimonialModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xs-12 pt-20 pb-20">
                                <p class="m-0 f16 fw-400 text-color">You need to login first if you want to send testimonial or feedback.</p>
                            </div>
                        </div>
                    </div>
